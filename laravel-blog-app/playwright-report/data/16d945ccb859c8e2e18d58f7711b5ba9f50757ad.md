...
- Name: Navigation.spec.ts >> Smoke: home page and navigation >> Posts link navigates to the Posts section
- Location: tests\Navigation.spec.ts:26:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: /^(Posts|Beiträge|Посты)$/ }) resolved to 2 elements:
